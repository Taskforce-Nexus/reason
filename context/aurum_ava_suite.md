...
- Cada producto tiene su propio ICP, precio y marca
- Los productos se complementan pero no se fuerzan a integrarse
- La conexión entre productos es vía outputs exportables
- Un usuario puede contratar uno solo o toda la suite
- No se construye el siguiente módulo hasta terminar el anterior
